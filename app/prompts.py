...
• No extra spacing, no markdown tables except the ones defined above.  
• Final output must be PDF-safe and match this structure exactly.
• CRITICAL - DO NOT USE MARKDOWN BOLD FORMATTING: Never use ** (double asterisks) anywhere in the output. All headings like "S – SUBJECTIVE", "O – OBJECTIVE", "A – ASSESSMENT", "P – PLAN", "PATIENT DEMOGRAPHICS", "CPT / BILLING CODES", "REQUEST FOR AUTHORIZATION (RFA)", "WORK STATUS" must be plain text without any ** around them. Output headings exactly as shown in the template without markdown formatting. Do NOT add ** to any text in the output.
